...
class SelectedRoute(_message.Message):
    __slots__ = ("worker_url", "eth_address", "capability", "offering", "price_per_work_unit_wei", "work_unit", "extra_json", "constraints_json", "quote_id", "quote_version", "constraint_fingerprint", "route_fingerprint", "units_per_price")
