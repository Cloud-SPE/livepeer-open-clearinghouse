...
from pymthouse.domains.billing import service
from pymthouse.domains.billing.types import (
    BalanceView,
    LedgerEntryView,
    LedgerPage,
    TopupRequest,
...
async def get_my_balance(
    ...
    return BalanceView(
        user_id=row.user_id, amount_wei=row.amount_wei, updated_at=row.updated_at
    )
