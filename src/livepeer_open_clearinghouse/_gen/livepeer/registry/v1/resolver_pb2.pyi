...
class ResolveResult(_message.Message):
    ...
    def __init__(
        self,
        eth_address: _Optional[str] = ...,
        resolved_uri: _Optional[str] = ...,
        mode: _Optional[_Union[_types_pb2.ResolveMode, str]] = ...,
        nodes: _Optional[_Iterable[_Union[_types_pb2.Node, _Mapping]]] = ...,
        freshness_status: _Optional[_Union[_types_pb2.FreshnessStatus, str]] = ...,
        cached_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        fetched_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
...
class SelectManyResult(_message.Message):
    ...
    def __init__(
        self, routes: _Optional[_Iterable[_Union[SelectedRoute, _Mapping]]] = ...
    ) -> None: ...
...
class ListKnownResult(_message.Message):
    ...
    def __init__(
        self, entries: _Optional[_Iterable[_Union[KnownEntry, _Mapping]]] = ...
    ) -> None: ...
...
class GetAuditLogRequest(_message.Message):
    ...
    def __init__(
        self,
        eth_address: _Optional[str] = ...,
        since: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        limit: _Optional[int] = ...,
    ) -> None: ...
...
class AuditLogResult(_message.Message):
    ...
    def __init__(
        self, events: _Optional[_Iterable[_Union[AuditEvent, _Mapping]]] = ...
    ) -> None: ...
...
class AuditEvent(_message.Message):
    ...
    def __init__(
        self,
        at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...,
        eth_address: _Optional[str] = ...,
        kind: _Optional[str] = ...,
        mode: _Optional[_Union[_types_pb2.ResolveMode, str]] = ...,
