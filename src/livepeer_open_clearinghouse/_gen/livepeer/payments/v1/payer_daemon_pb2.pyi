...
class CreatePaymentResponse(_message.Message):
    __slots__ = ("payment_bytes", "tickets_created", "expected_value", "funded_value_wei", "accepted_quote_ref", "work_id", "predecessor_work_id", "creation_round", "expires_after_round", "ticket_validity_period", "ticket_validity_period_observed_at")
