...
class CreateSpendAuthorizationRequest(_message.Message):
    __slots__ = ("wholesale_account_id", "payee", "authorization_id", "request_id", "session_id", "protocol", "accepted_price", "max_debit_wei", "max_total_units", "not_before", "expires_at", "request_digest", "caller_public_key", "revision", "predecessor_authorization_id", "broker_uri", "chain_id", "denomination", "settlement_domain_id")
