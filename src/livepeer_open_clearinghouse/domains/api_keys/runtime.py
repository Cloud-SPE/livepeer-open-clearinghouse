...
from livepeer_open_clearinghouse.domains.api_keys import service
from livepeer_open_clearinghouse.domains.api_keys.types import (
    ApiKeyList,
    ApiKeyView,
    CreateApiKeyRequest,
...
async def revoke_api_key_endpoint(
    ...
    try:
        row = await service.revoke(db, user_id=user.id, api_key_id=api_key_id, clock=clock)
