...
SESSION_COOKIE_NAME = "open_clearinghouse_session"
...
def make_serializer(
    secret: str, salt: str = "open-clearinghouse-session"
...
def unseal(serializer: URLSafeTimedSerializer, signed: str, max_age_seconds: int) -> str | None:
