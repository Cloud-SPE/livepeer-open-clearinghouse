...
export const icon = {
  ...
  chart: () =>
    base(svg`<path d="M4 20V10"/><path d="M10 20V4"/><path d="M16 20v-7"/><path d="M22 20H2"/>`),
  alert: () =>
    base(svg`<path d="M12 9v4"/><path d="M12 17h.01"/><path d="M10.3 3.9 2.4 17.6A2 2 0 0 0 4.1 20.6h15.8a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/>`),
  chevron: () =>
    base(svg`<path d="m6 9 6 6 6-6"/>`),
  activity: () =>
