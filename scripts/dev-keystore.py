...
def main() -> int:
    ...
    print("  command:")
    print("    - --chain-rpc-urls=${CHAIN_RPC_URLS}")
    print("    - --max-payment-wei=${MAX_PAYMENT_WEI}")
    print("    - --db=/var/lib/livepeer/payment-daemon/sessions.db")
    print("    - --keystore-path=/etc/livepeer/keystore.json")
    print("    - --keystore-password-file=/etc/livepeer/keystore-password")
    print("  volumes:")
    print("    - payment-daemon-data:/var/lib/livepeer/payment-daemon")
