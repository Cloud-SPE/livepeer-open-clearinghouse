...
#   timestamp: 2026-09-09T20:22:18+00:00
...
class BillingConfigUpdate:
    ...
    spend_period_cap_wei: float | str | int | None = None
    auto_replenish_increment_wei: float | str | int | None = None
    auto_replenish_threshold_wei: float | str | int | None = None
...
class BillingConfigView:
    ...
    spend_period_cap_wei: str | None
    auto_replenish_increment_wei: str | None
    auto_replenish_threshold_wei: str | None
...
class AccountingMode(Enum):
    ...
    wholesale_account = "wholesale_account"
...
class EffectiveBillingConfigView:
    ...
    spend_period_cap_wei: str
    auto_replenish_increment_wei: str
    auto_replenish_threshold_wei: str
...
class LedgerEntryView:
    ...
    created_at: str
    related_engagement_id: str | None = None
...
class RefillSessionResponse:
    ...
    accounting_mode: AccountingMode | None = AccountingMode.legacy_ticket
    rebind_from: str | None = None
...
@dataclass
class ResolveJobRequest:
    action: Action
    note: str | None = None


@dataclass
class ResolveJobResponse:
    job_id: str
    protocol: str
    action: Action
    state: str
...
class UsageJobView:
    ...
    sdk_identity: str | None
    state: str
    accounting_outcome: AccountingOutcome1
    work_unit: str
    estimated_units: int
    max_total_units: int
    actual_units: int | None
...
class WholesaleAccountView:
    ...
    broker_url: str
    credited_value_wei: str
    reserved_value_wei: str
    debited_value_wei: str
    available_value_wei: str
    remote_version: int
    observed_at: str
    age_seconds: float
    stale: bool
...
@dataclass
class WholesaleFundingView:
    id: str
    account_id: str
    mint_request_id: str
    correlation_id: str | None
    target_available_wei: str
    observed_available_wei: str
    requested_shortfall_wei: str
    minted_expected_value_wei: str
    credited_value_wei: str | None
    work_id: str | None
...
@dataclass
class WholesaleLimitsView:
    enabled: bool
    target_available_wei: str
    replenish_below_wei: str
    max_available_per_payee_wei: str
    max_aggregate_available_wei: str
    max_single_funding_wei: str


@dataclass
class WholesaleOverview:
    generated_at: str
    limits: WholesaleLimitsView
    projected_available_wei: str
    observed_available_wei: str
    aggregate_headroom_wei: str
